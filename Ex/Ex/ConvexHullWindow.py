...
class ConvexHullWin(QWidget):
    ...
    def initUI(self):
        ...
        self.setObjectName("graham")
        self.setWindowTitle('Convex Hull Algorithm')
        self.setStyleSheet('''
        #graham {
            background: #002f1f;
        }
    ...
    def drawGraph(self):
        ...
        try:
            points = GeoAlgorithms.Convex_Hull(data)
        except:
            return
        x, y = (0, 0)
        ...
        path = "./pics/Graham#{}.png".format(pic_id)
        plt.savefig(path)
