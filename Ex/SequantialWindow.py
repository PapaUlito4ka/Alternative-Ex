...
class SequantialWin(QWidget):
    ...
    def initUI(self):
        ...
        self.setObjectName("sequantial")
        self.setWindowTitle('Sequantial Algorithm')
        self.setStyleSheet('''
        #sequantial {
            background: #002f1f;
        }
    ...
    def drawGraph(self):
        ...
        try:
            points = GeoAlgorithms.Sequential(data)
            print(points)
        except:
            return
        x, y = (0, 0)
        ...
        path = "./pics/Sequantial#{}.png".format(pic_id)
        plt.savefig(path)
